...
![](http://images.cnblogs.com/cnblogs_com/hustcat/mysql/mysql02-04.JPG)
...
![](http://images.cnblogs.com/cnblogs_com/hustcat/mysql/mysql02-05.JPG)

 注：左边为行号(row number)，从0开始。因为元组的大小固定，所以MyISAM可以很容易的从表的开始位置找到某一字节的位置。
据些建立的primary key的索引结构大致如下：

![](http://images.cnblogs.com/cnblogs_com/hustcat/mysql/mysql02-06.JPG)

 注：MyISAM不支持聚簇索引，索引中每一个叶子节点仅仅包含行号(row number)，且叶子节点按照col1的顺序存储。
来看看col2的索引结构：

![](http://images.cnblogs.com/cnblogs_com/hustcat/mysql/mysql02-07.JPG)
...
![](http://images.cnblogs.com/cnblogs_com/hustcat/mysql/mysql02-08.JPG)
 ...
 ![](http://images.cnblogs.com/cnblogs_com/hustcat/mysql/mysql02-09.JPG)
 
  聚簇索引和非聚簇索引表的对比：
  
   ![](http://images.cnblogs.com/cnblogs_com/hustcat/mysql/mysql02-10.JPG)
   
3.1.2、按primary key的顺序插入行(InnoDB)  </br>
